...
--- * `Active` - Quest is running
--- * `Decided` - Quest outcome is desiced
--- * `Done` - Quest is done
QuestState = {
    --- Quest is inactive
    Inactive = 1,
...
--- Quest results
--- 
--- * `None` - Quest result was undecided
--- * `Success` - Quest ended in success
--- * `Failure` - Quest ended in failure
--- * `Interrupt` - Quest has been interrupted
QuestResult = {
    --- Quest result was undecided
    None = 1,
    --- Quest ended in success
    Success = 2,
...
--- Technology states
--- 
--- * `Researched` - Technology is researched
--- * `Allowed` - Technology is allowed
--- * `Forbidden` - Technology is forbidden
TechnologyStates = {
...
--- Marker types
--- 
--- * `StaticFriendly` - A static green marker
--- * `StaticNeutral` - A static white marker
--- * `StaticEnemy` - A static red marker
--- * `PulseFriendly` - A pulsating green marker
--- * `PulseNeutral` - A pulsating white marker
--- * `PulseEnemy` - A pulsating red marker
MarkerTypes = {
    --- A static green marker
    StaticFriendly = 1,
    --- A static white marker
    StaticNeutral  = 2,
    --- A static red marker
    StaticEnemy    = 3,
    --- A pulsating green marker
    PulseFriendly  = 4,
    --- A pulsating white marker
    PulseNeutral   = 5,
    --- A pulsating red marker
    PulseEnemy     = 6,
}
